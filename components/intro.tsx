...
const Intro = () => {
  ...
  return (
    <section ref={ref} id="home" className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
        <div className='flex items-center justify-center pb-[0.5rem]'>
            <div className='relative'>
                <motion.div 
                    ...
                    <Image  width="250" height="250" quality="95" priority={true} src="https://i.pinimg.com/originals/59/9c/b9/599cb96a0adc21064c635d3de237fc04.jpg" alt="colt-pfp"
        ...
        interest in Problem Solving and Algorithms. I also love 
        building <span className="italic">Websites</span>. My focus is{" "}
        <span className=''><span className='font-bold'>MERN</span> Stack</span>.
        </motion.h1>

...
export const metadata = {
  ...
  description: 'An Aspiring Full Stack Developer with sharp Problem solving Skills and grasp at DSA.',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className='!scroll-smooth'>
      <body className={`${inter.className} bg-slate-200 text-gray-950 relative h-[5000px] pt-28 sm:pt-38`}>
